...
internal extension UIView {
    ...
    @discardableResult func pinItem(_ item: AnyObject, attribute: NSLayoutAttribute, to toItem: AnyObject, toAttribute: NSLayoutAttribute?=nil, withOffset offset: CGFloat=0, andScale scale: CGFloat=1, priority: UILayoutPriority?=nil) -> NSLayoutConstraint {
